...
solutions = ["Qd1+","d5","f5","e6","a4","g6","Nf6","f5","f5","Ne5","f4","Bf5","b4",
             "Qd2","Qxg7+","Ne4","h5","Nb3","Rxe4","g4","Nh6","Bxe4","f6","f4"]
...
for i in range(24):
    ...
    print(board.san(board.parse_uci(str(result.move))), solutions[i])
    if str(board.san(board.parse_uci(str(result.move)))) == solutions[i]:
        correct += 1
    
print (correct, correct / 24.0)
